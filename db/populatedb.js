...
INSERT INTO items (category_id, name, description, price)
VALUES
((SELECT id from categories WHERE name = 'Video Games'), 'Steam Machine', 'Your games on the big screen. Powerful PC gaming made easy, in a small and mighty package.', 1049.00);
`;
